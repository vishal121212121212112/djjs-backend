...
// swagger:model ChildBranch
type ChildBranch struct {
	ID              uint       `gorm:"primaryKey;autoIncrement" json:"id"`
	ParentBranchID  uint       `gorm:"not null;column:parent_branch_id" json:"parent_branch_id" validate:"required,min=1"`
	ParentBranch    Branch     `gorm:"foreignKey:ParentBranchID" json:"parent_branch,omitempty"`
	...
	Infrastructures []ChildBranchInfrastructure `gorm:"foreignKey:ChildBranchID" json:"infrastructure,omitempty"`
	Members         []ChildBranchMember         `gorm:"foreignKey:ChildBranchID" json:"members,omitempty"`
...
func (ChildBranch) TableName() string {
	return "child_branch"
}

// swagger:model ChildBranchInfrastructure
type ChildBranchInfrastructure struct {
	ID            uint        `gorm:"primaryKey;autoIncrement" json:"id"`
	ChildBranchID uint        `gorm:"not null;column:child_branch_id" json:"child_branch_id" validate:"required,min=1"`
	ChildBranch   ChildBranch `gorm:"foreignKey:ChildBranchID" json:"child_branch,omitempty"`
...
func (ChildBranchInfrastructure) TableName() string {
	return "child_branch_infrastructure"
}

// swagger:model ChildBranchMember
type ChildBranchMember struct {
	ID             uint        `gorm:"primaryKey;autoIncrement" json:"id"`
...
func (ChildBranchMember) TableName() string {
	return "child_branch_member"
}
